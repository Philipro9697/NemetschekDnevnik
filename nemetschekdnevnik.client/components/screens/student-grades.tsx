...
function decodeComment(comment: string | null | undefined, gradeTypeName: string | null | undefined): { section: GradeSection; text: string } {
    if (comment) {
        ...
        if (match) {
            ...
            // Map 'term1' to the expected 'Текущо изпитване' type from @/lib/data
            if (sectionKey === "term1") {
                return { section: "Текущо изпитване", text: comment.slice(match[0].length) };
            }
    ...
    if (gradeTypeName === "Текущо изпитване" || gradeTypeName === "term1") return { section: "Текущо изпитване", text: comment ?? "" };
    ...
    return { section: "Текущо изпитване", text: comment ?? "" };
}
