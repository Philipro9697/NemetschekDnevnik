...
export const schedule: Lesson[] = [
  { period: 1, time: '08:00', subjectId: 'mat', teacherId: 't1', classId: 'c5a', room: '204' },
  { period: 2, time: '08:55', subjectId: 'bel', teacherId: 't2', classId: 'c5a', room: '108' },
  { period: 3, time: '09:50', subjectId: 'ae', teacherId: 't3', classId: 'c5a', room: '301' },
  { period: 4, time: '11:00', subjectId: 'ist', teacherId: 't2', classId: 'c5a', room: '108' },
  { period: 5, time: '11:55', subjectId: 'chp', teacherId: 't3', classId: 'c5a', room: '210' },
  { period: 6, time: '12:50', subjectId: 'it', teacherId: 't1', classId: 'c5a', room: '215' },
]

/* Teacher t1 lessons today (across classes) */
export const teacherSchedule: Lesson[] = [
  { period: 1, time: '08:00', subjectId: 'mat', teacherId: 't1', classId: 'c5a', room: '204' },
  { period: 2, time: '08:55', subjectId: 'mat', teacherId: 't1', classId: 'c6b', room: '204' },
  { period: 4, time: '11:00', subjectId: 'mat', teacherId: 't1', classId: 'c5b', room: '204' },
  { period: 6, time: '12:50', subjectId: 'it', teacherId: 't1', classId: 'c5a', room: '215' },
]
...
export const seedHomework: Homework[] = [
  {
    ...
    description: 'Реши задачи 12–18 от стр. 45 в учебника. Запиши решенията подробно в тетрадката и качи снимка.',
    assignedDate: iso(1),
    dueDate: iso(-2),
    type: 'homework',
  ...
  },
  {
    ...
    description: 'Напиши съчинение (15–20 изречения) по картината „Есен в парка". Обърни внимание на описанието.',
    assignedDate: iso(3),
    dueDate: iso(-4),
    type: 'homework',
    submissions: [],
  },
  {
    ...
    description: 'Материал за самостоятелна подготовка преди следващия час. Прегледайте слайдовете.',
    assignedDate: iso(2),
    dueDate: iso(-5),
    type: 'material',
    submissions: [],
...
export const seedEvents: CalendarEvent[] = [
  { id: 'e1', title: 'Контролно по История', date: iso(-3), type: 'exam', classIds: ['c5a'], description: 'Раздел „Древен Рим".' },
  { id: 'e2', title: 'Класно по Математика', date: iso(-8), type: 'exam', classIds: ['c5a'], description: 'Дроби и проценти.' },
  { id: 'e3', title: 'Родителска среща', date: iso(-5), type: 'event', classIds: ['c5a'], description: 'Начало 18:00 ч., стая 204.' },
  { id: 'e4', title: 'Патронен празник', date: iso(-12), type: 'event', classIds: [], description: 'Общоучилищно събитие.' },
  { id: 'e5', title: 'Контролно по Английски', date: iso(-1), type: 'exam', classIds: ['c5a'], description: 'Units 1–3.' },
]
...
export const seedThreads: Thread[] = [
  {
    ...
    messages: [
      { id: 'm1', senderId: 't1', text: 'Здравейте! Напомням за родителската среща в петък от 18:00 ч.', time: iso(2) + ' 09:12' },
      { id: 'm2', senderId: 'p1', text: 'Добър ден, благодаря! Ще присъствам.', time: iso(2) + ' 10:03' },
    ],
  },
  {
    id: 'th2',
    ...
    messages: [
      { id: 'm3', senderId: 't2', text: 'Резултатите от контролното ще бъдат нанесени до края на седмицата.', time: iso(1) + ' 14:20' },
    ],
  },
]
